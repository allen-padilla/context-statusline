...
run_case "reset overdue"  "$(payload 12 12 12 $((now - 60)))"            "$(usage_cache 12 12 12 $((now - 60)))" "Fable 12% 00:00"
run_case "countdown"      "$(payload 12 12 12 $((now + 18753)))"         "$(usage_cache 12 12 12 $((now + 18753)))" "7d 12% | Fable 12% 05:12"
run_case "just under 24h" "$(payload 12 12 12 $((now + 86399)))"         "$(usage_cache 12 12 12 $((now + 86399)))" "Fable 12% 23:59"
